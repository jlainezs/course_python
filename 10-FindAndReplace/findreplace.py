...
assert find_and_replace_short_version('The fox', 'fox', 'dog') == 'The dog'
assert find_and_replace_short_version('fox', 'fox', 'dog') == 'dog'
assert find_and_replace_short_version('Firefox', 'fox', 'dog') == 'Firedog'
assert find_and_replace_short_version('foxfox', 'fox', 'dog') == 'dogdog'
assert find_and_replace_short_version('The Fox and fox.', 'fox', 'dog') == 'The Fox and dog.'
